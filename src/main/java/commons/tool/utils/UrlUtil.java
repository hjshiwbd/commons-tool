...
import commons.tool.exception.URLException;
...
public class UrlUtil {
    ...
    public static String get(String url) {
        return get(url, "UTF-8", createConfig(), null);
    }

    public static String get(String url, String encoding) {
        return get(url, encoding, createConfig(), null);
    }
     ...
     * 
     */
    public static String get(String url, String encoding, RequestConfig config, Header[] headers) {
    ...
    public static String post(String url, List<NameValuePair> postParams, String encoding) throws Exception {
        return post(url, postParams, null, encoding, createConfig(), null);
    }

    public static String post(String url, String postString, String encoding) throws Exception {
        return post(url, null, postString, encoding, createConfig(), null);
    }
    ...
    public static String post(String url, List<NameValuePair> postParams, String postString, String encoding,
            RequestConfig config, Header[] headers) throws Exception {
