...
import org.shinomin.commons.bean.MailAttachmentBean;
...
public class MailUtil
{
	        ...
	        String mailPassword) throws Exception
	{
		...
		send(displayName, mailBoxTo, title, content, mailServer, mailAccount,
		        mailPassword, files);
	}
	...
	public static void send(String displayName, String mailBoxTo, String title,
	        String content, String mailServer, String mailAccount,
	        String mailPassword, MailAttachmentBean[] attachFiles)
	        throws Exception
	{
		...
		// 设置收件人,并设置其接收类型为TO
		InternetAddress to = new InternetAddress(mailBoxTo);
	 ...
	 * @throws Exception
	 */
	public static Store connectMail(String servername, String username,
	 ...
	 * @throws Exception
	 */
	public static Store connectIMAPMail(String imapserver, String username,
	        String password) throws Exception
	{
